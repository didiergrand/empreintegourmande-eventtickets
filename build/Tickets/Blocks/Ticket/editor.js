...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/style.pcss
var style = __webpack_require__("0/v6");
...
var template = __webpack_require__("jKQp");
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/title/styles.pcss
var styles = __webpack_require__("vQ01");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/title/template.js
...
class template_Title extends external_React_["PureComponent"] {
  ...
  render() {
    ...
    return wp.element.createElement("div", {
      ...
      ,
      label: sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('%s name', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular)
...
/* harmony default export */ var title_template = (template_Title);
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/title/container.js
/**
 * External dependencies
 */
...
const mapStateToProps = (state, ownProps) => ({
  ...
  tempTitle: htmlEntityDecode(ticket["f" /* selectors */].getTicketTempTitle(state, ownProps))
});
const mapDispatchToProps = (dispatch, ownProps) => ({
  onTempTitleChange: e => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempTitle(clientId, e.target.value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
/* harmony default export */ var container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(mapStateToProps, mapDispatchToProps))(title_template));
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/title/container.js
/**
 * External dependencies
 */
...
const container_mapStateToProps = (state, ownProps) => ({
  hasAttendeeInfoFields: ticket["f" /* selectors */].getTicketHasAttendeeInfoFields(state, ownProps),
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  tempTitle: htmlEntityDecode(ticket["f" /* selectors */].getTicketTempTitle(state, ownProps)),
  title: htmlEntityDecode(ticket["f" /* selectors */].getTicketTitle(state, ownProps))
});
const container_mapDispatchToProps = (dispatch, ownProps) => ({
  onTempTitleChange: e => {
    const {
      clientId
    } = ownProps;
...
/* harmony default export */ var title_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(container_mapStateToProps, container_mapDispatchToProps))(template["a" /* default */]));
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/description/container.js
/**
 * External dependencies
 */
...
const description_container_mapStateToProps = (state, ownProps) => ({
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  tempDescription: ticket["f" /* selectors */].getTicketTempDescription(state, ownProps),
  description: ticket["f" /* selectors */].getTicketDescription(state, ownProps)
});
const description_container_mapDispatchToProps = (dispatch, ownProps) => ({
  onTempDescriptionChange: e => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempDescription(clientId, e.target.value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
/* harmony default export */ var description_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(description_container_mapStateToProps, description_container_mapDispatchToProps))(description_template["a" /* default */]));
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/price/container.js
/**
 * External dependencies
 */
...
const price_container_mapStateToProps = (state, ownProps) => ({
  available: ticket["f" /* selectors */].getTicketAvailable(state, ownProps),
...
const price_container_mapDispatchToProps = (dispatch, ownProps) => ({
  onTempPriceChange: e => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempPrice(clientId, e.target.value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
/* harmony default export */ var price_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(price_container_mapStateToProps, price_container_mapDispatchToProps))(price_template["a" /* default */]));
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/quantity/container.js
/**
 * External dependencies
 */
...
const getSharedSold = (state, isShared) => isShared ? ticket["f" /* selectors */].getSharedTicketsSold(state) : 0;
const quantity_container_mapStateToProps = (state, ownProps) => {
  const isShared = ticket["f" /* selectors */].isSharedTicket(state, ownProps);
  return {
    isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
    isShared,
    isUnlimited: ticket["f" /* selectors */].isUnlimitedTicket(state, ownProps),
    sold: ticket["f" /* selectors */].getTicketSold(state, ownProps),
    capacity: ticket["f" /* selectors */].getTicketCapacityInt(state, ownProps),
    sharedSold: getSharedSold(state, isShared),
    sharedCapacity: ticket["f" /* selectors */].getTicketsSharedCapacityInt(state)
  };
};
/* harmony default export */ var quantity_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(quantity_container_mapStateToProps))(quantity_template["a" /* default */]));
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/style.pcss
var container_header_style = __webpack_require__("c9DT");

// EXTERNAL MODULE: external "wp.hooks"
var external_wp_hooks_ = __webpack_require__("g56x");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-header/template.js
/**
 * External dependencies
 */
...
const TicketContainerHeader = ({
  ...
  let detailsItems = [wp.element.createElement(OnSaleLabel, {
    isOnSale: isOnSale
   ...
   */
  detailsItems = Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.Ticket.header.detailItems', detailsItems, clientId);
  ...
  }, detailsItems.map((item, index) => wp.element.createElement(external_React_["Fragment"], {
    key: index
  }, item))), wp.element.createElement(price_container, {
    clientId: clientId,
    isSelected: isSelected
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/capacity/style.pcss
var capacity_style = __webpack_require__("AubK");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/capacity/template.js




const _excluded = ["className", "id", "label"];
/**
 * External dependencies
 */
...
class template_Capacity extends external_React_["PureComponent"] {
    ...
    defineProperty_default()(this, "getInputs", () => {
      ...
      if (tempCapacityType === TICKET_TYPES[SHARED] && sharedCapacity === '') {
        inputs.push(wp.element.createElement(LabeledNumberInput, {
          ...
          value: tempSharedCapacity !== null && tempSharedCapacity !== void 0 ? tempSharedCapacity : '',
      ...
      if (external_lodash_includes_default()([TICKET_TYPES[SHARED], TICKET_TYPES[INDEPENDENT]], tempCapacityType)) {
        const extraProps = {};
        ...
        // eslint-disable-next-line no-undef
        sprintf(/* Translators: %s - the singular, lowercase label for a ticket. */
        Object(external_wp_i18n_["__"])('Limit sales of this %s to:', 'event-tickets'), TICKET_LABELS.ticket.singularLowercase) :
        // eslint-disable-next-line no-undef
        sprintf(/* Translators: %s - the plural, lowercase label for a ticket. */
        Object(external_wp_i18n_["__"])('Number of %s available', 'event-tickets'), TICKET_LABELS.ticket.pluralLowercase);
        inputs.push(wp.element.createElement(LabeledNumberInput, extends_default()({
          ...
          value: tempCapacity !== null && tempCapacity !== void 0 ? tempCapacity : '',
  ...
  render() {
     ...
     */
    renderForm = Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.Ticket.Capacity.renderForm', renderForm, this.props);
    return wp.element.createElement("div", {
    ...
    }, wp.element.createElement(modules_elements["LabelWithTooltip"], {
      ...
      ,
      label: sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('%s Capacity', 'event-tickets'), TICKET_LABELS.ticket.singular)
...
defineProperty_default()(template_Capacity, "propTypes", {
  ...
  isDisabled: external_tribe_modules_propTypes_default.a.bool,
  sharedCapacity: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.string, external_tribe_modules_propTypes_default.a.number]),
  tempCapacity: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.string, external_tribe_modules_propTypes_default.a.number]),
  ...
  tempCapacityTypeOption: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_common_data_plugins_proptypes_["ReactSelectOption"], external_tribe_modules_propTypes_default.a.object]),
...
defineProperty_default()(template_Capacity, "defaultProps", {
  tempCapacityTypeOption: []
});
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/capacity/container.js
/**
 * External dependencies
 */
...
const capacity_container_mapStateToProps = (state, ownProps) => ({
  ...
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  sharedCapacity: ticket["f" /* selectors */].getTicketsSharedCapacity(state),
...
const capacity_container_mapDispatchToProps = (dispatch, ownProps) => {
  ...
  return {
    onTempCapacityChange: e => {
      dispatch(ticket["a" /* actions */].setTicketTempCapacity(clientId, e.target.value));
      dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
    },
    onTempCapacityNoPlusChange: e => {
      const capacity = e.target.value;
      const capacityType = external_lodash_trim_default()(capacity) === '' ? container_TICKET_TYPES[UNLIMITED] : container_TICKET_TYPES[container_INDEPENDENT];
      dispatch(ticket["a" /* actions */].setTicketTempCapacityType(clientId, capacityType));
      dispatch(ticket["a" /* actions */].setTicketTempCapacity(clientId, capacity));
      dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
    },
    onTempCapacityTypeChange: selectedOption => {
      dispatch(ticket["a" /* actions */].setTicketTempCapacityType(clientId, selectedOption.value));
      dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
    },
    onTempSharedCapacityChange: e => {
      dispatch(ticket["a" /* actions */].setTicketsTempSharedCapacity(e.target.value));
      dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
    }
  };
};
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/duration/style.pcss
var duration_style = __webpack_require__("692c");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/duration/template.js


const template_excluded = ["hasDurationError"];
/**
 * External dependencies
 */
...
const TicketDuration = _ref => {
  let {
    ...
    props = objectWithoutProperties_default()(_ref, template_excluded);
  return wp.element.createElement("div", {
  ...
  }), wp.element.createElement(modules_elements["DateTimeRangePicker"], extends_default()({
...
/* harmony default export */ var duration_template = (TicketDuration);
// EXTERNAL MODULE: external "tribe.common.utils"
var external_tribe_common_utils_ = __webpack_require__("B8vQ");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/duration/container.js
...
const onFromTimePickerChange = (dispatch, ownProps) => e => {
  dispatch(ticket["a" /* actions */].setTicketTempStartTimeInput(ownProps.clientId, e.target.value));
};
...
const onToTimePickerChange = (dispatch, ownProps) => e => {
  dispatch(ticket["a" /* actions */].setTicketTempEndTimeInput(ownProps.clientId, e.target.value));
};
const onToTimePickerClick = (dispatch, ownProps) => (value, onClose) => {
  dispatch(ticket["a" /* actions */].handleTicketEndTime(ownProps.clientId, value));
  onClose();
};
const onFromTimePickerBlur = (state, dispatch, ownProps) => e => {
  ...
  if (!startTimeMoment.isValid()) {
    const startTimeInput = ticket["f" /* selectors */].getTicketStartTimeInput(state, ownProps);
  ...
  dispatch(ticket["a" /* actions */].handleTicketStartTime(ownProps.clientId, seconds));
};
const onToTimePickerBlur = (state, dispatch, ownProps) => e => {
  ...
  if (!endTimeMoment.isValid()) {
    const endTimeInput = ticket["f" /* selectors */].getTicketEndTimeInput(state, ownProps);
  ...
  dispatch(ticket["a" /* actions */].handleTicketEndTime(ownProps.clientId, seconds));
};
const duration_container_mapStateToProps = (state, ownProps) => {
  ...
  const isDisabled = ticket["f" /* selectors */].isTicketDisabled(state, ownProps);
  ...
  return {
    fromDate,
    fromDateInput: ticket["f" /* selectors */].getTicketTempStartDateInput(state, ownProps),
    fromDateDisabled: isDisabled,
    fromDateFormat: datePickerFormat,
    fromTime: ticket["f" /* selectors */].getTicketTempStartTimeInput(state, ownProps),
    fromTimeDisabled: isDisabled,
    hasDurationError: ticket["f" /* selectors */].getTicketHasDurationError(state, ownProps),
    toDate,
    toDateInput: ticket["f" /* selectors */].getTicketTempEndDateInput(state, ownProps),
    toDateDisabled: isDisabled,
    toDateFormat: datePickerFormat,
    toTime: ticket["f" /* selectors */].getTicketTempEndTimeInput(state, ownProps),
...
const mergeProps = (stateProps, dispatchProps, ownProps) => {
  ...
  return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ownProps), restStateProps), restDispatchProps), {}, {
...
/* harmony default export */ var duration_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(duration_container_mapStateToProps, duration_container_mapDispatchToProps, mergeProps))(duration_template));
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/style.pcss
var advanced_options_style = __webpack_require__("fF5y");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/sku/template.js
...
class template_SKU extends external_React_["PureComponent"] {
  ...
  render() {
    ...
    return wp.element.createElement("div", {
      ...
      ,
      label: sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('%s SKU', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular)
      // eslint-disable-next-line no-undef
      ,
      tooltipText: sprintf(/* Translators: %s - the singular, lowercase label for a ticket. */
      Object(external_wp_i18n_["__"])("A unique identifying code for each %s type you're selling", 'event-tickets'), constants["TICKET_LABELS"].ticket.singularLowercase),
      tooltipLabel: wp.element.createElement(external_wp_components_["Dashicon"], {
        className: "tribe-editor__ticket__tooltip-label",
        icon: "info-outline"
      })
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/sku/container.js
/**
 * External dependencies
 */
...
const sku_container_mapStateToProps = (state, ownProps) => ({
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  sku: ticket["f" /* selectors */].getTicketTempSku(state, ownProps)
});
const sku_container_mapDispatchToProps = (dispatch, ownProps) => ({
  onChange: e => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempSku(clientId, e.target.value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/ecommerce-options/style.pcss
var ecommerce_options_style = __webpack_require__("JOLU");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/ecommerce-options/template.js
/**
 * External dependencies
 */
...
const {
  ...
  WOO,
  PROVIDER_TYPES,
  TICKET_LABELS: template_TICKET_LABELS
} = ticket["b" /* constants */];
...
const EcommerceOptions = ({
  ...
  const getEditTicketLinkLabel = ticketProvider => {
    ...
    if (ticketProvider === EDD) {
      // eslint-disable-next-line no-undef
      label = sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('Edit %s in Easy Digital Downloads', 'event-tickets'), template_TICKET_LABELS.ticket.singular // eslint-disable-line camelcase, no-undef
      );
    } else if (ticketProvider === WOO) {
      // eslint-disable-next-line no-undef
      label = sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('Edit %s in WooCommerce', 'event-tickets'), template_TICKET_LABELS.ticket.singular // eslint-disable-line camelcase, no-undef
      );
    }
    return label;
  };
...
EcommerceOptions.propTypes = {
  ...
  provider: external_tribe_modules_propTypes_default.a.oneOf([...PROVIDER_TYPES, '', 'tc']),
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/ecommerce-options/container.js
/**
 * External dependencies
 */
...
const getEditTicketLink = (state, ownProps, provider) => {
  ...
  if (container_showEcommerceOptions(provider)) {
    ...
    const ticketId = ticket["f" /* selectors */].getTicketId(state, ownProps);
...
const ecommerce_options_container_mapStateToProps = (state, ownProps) => {
  const provider = ticket["f" /* selectors */].getTicketProvider(state, ownProps);
  return {
    isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
    provider,
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/template.js
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/advanced-options/container.js
/**
 * External dependencies
 */
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendee-collection/style.pcss
var attendee_collection_style = __webpack_require__("6bak");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendee-collection/iac-setting/template.js
...
class template_IACSetting extends external_React_["PureComponent"] {
  ...
  render() {
    ...
    // eslint-disable-next-line no-undef
    sprintf(/* Translators: %1$s - the plural, lowercase label for a ticket;  %2$s - the singular, lowercase label for a ticket. */
    Object(external_wp_i18n_["__"])('Select the default way to sell %1$s. Enabling Individual Attendee Collection will allow purchasers to enter a name and email for each %2$s.',
    // eslint-disable-line max-len
    'event-tickets'), constants["TICKET_LABELS"].ticket.pluralLowercase, constants["TICKET_LABELS"].ticket.singularLowercase)), wp.element.createElement("div", {
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendee-collection/iac-setting/container.js
/**
 * External dependencies
 */
...
const iac_setting_container_mapStateToProps = (state, ownProps) => ({
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  iac: ticket["f" /* selectors */].getTicketTempIACSetting(state, ownProps),
...
const iac_setting_container_mapDispatchToProps = (dispatch, ownProps) => ({
  onChange: value => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempIACSetting(clientId, value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendee-collection/template.js
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendee-collection/container.js
/**
 * External dependencies
 */
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendees-registration/style.pcss
var attendees_registration_style = __webpack_require__("1uGs");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendees-registration/template.js
/**
 * External dependencies
 */
...
const AttendeesRegistration = ({
  ...
  // eslint-disable-next-line no-undef
  , {
    helperText: sprintf(/* Translators: %s - the singular, lowercase label for a ticket. */
    Object(external_wp_i18n_["__"])('Save your %s to enable attendee information fields', 'event-tickets'), constants["TICKET_LABELS"].ticket.singularLowercase),
...
AttendeesRegistration.propTypes = {
  ...
  isDisabled: external_tribe_modules_propTypes_default.a.bool,
  isModalOpen: external_tribe_modules_propTypes_default.a.bool,
  onClick: external_tribe_modules_propTypes_default.a.func,
  onClose: external_tribe_modules_propTypes_default.a.func,
  onIframeLoad: external_tribe_modules_propTypes_default.a.func
};
/* harmony default export */ var attendees_registration_template = (AttendeesRegistration);
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/attendees-registration/container.js
/**
 * External dependencies
 */
...
const attendees_registration_container_mapStateToProps = (state, ownProps) => {
  const isCreated = ticket["f" /* selectors */].getTicketHasBeenCreated(state, ownProps);
  return {
    attendeeRegistrationURL: getAttendeeRegistrationUrl(state, ownProps),
    hasAttendeeInfoFields: ticket["f" /* selectors */].getTicketHasAttendeeInfoFields(state, ownProps),
    isCreated,
    isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps) || !isCreated,
    isModalOpen: ticket["f" /* selectors */].getTicketIsModalOpen(state, ownProps)
  };
};
  ...
  return {
    ...
    onIframeLoad: iframe => {
      ...
      const handleUnload = () => {
        ...
        // dispatch actions
        dispatch(ticket["a" /* actions */].setTicketHasAttendeeInfoFields(ownProps.clientId, hasFields));
        dispatch(ticket["a" /* actions */].setTicketIsModalOpen(ownProps.clientId, false));
      };
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/description/styles.pcss
var description_styles = __webpack_require__("tuaj");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/description/template.js
...
defineProperty_default()(template_Description, "defaultProps", {
  isDisabled: false,
  onTempDescriptionChange: () => {},
  tempDescription: ''
});
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/description/container.js
/**
 * External dependencies
 */
...
var external_lodash_isString_ = __webpack_require__("5vqK");
var external_lodash_isString_default = /*#__PURE__*/__webpack_require__.n(external_lodash_isString_);
...
function template_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function template_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? template_ownKeys(Object(t), !0).forEach(function (r) { defineProperty_default()(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : template_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
/**
 * External dependencies
 */
...
defineProperty_default()(template_SalePrice, "propTypes", {
  ...
  minDefaultPrice: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.string, external_tribe_modules_propTypes_default.a.number]),
  ...
  fromDate: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.instanceOf(Date), external_tribe_modules_propTypes_default.a.oneOf([''])]),
  toDate: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.instanceOf(Date), external_tribe_modules_propTypes_default.a.oneOf([''])]),
  fromDateInput: external_tribe_modules_propTypes_default.a.string,
  toDateInput: external_tribe_modules_propTypes_default.a.string,
  onFromDateChange: external_tribe_modules_propTypes_default.a.func,
  onToDateChange: external_tribe_modules_propTypes_default.a.func,
...
const sale_price_container_onFromDateChange = (dispatch, ownProps) => (date, modifiers, dayPickerInput) => {
  ...
  if (external_lodash_isString_default()(dayPickerInput) && dayPickerInput === '' || !external_lodash_isString_default()(dayPickerInput) && dayPickerInput.input.value === '') {
...
function price_template_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function price_template_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? price_template_ownKeys(Object(t), !0).forEach(function (r) { defineProperty_default()(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : price_template_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
/**
 * External dependencies
 */
...
class template_Price extends external_React_["PureComponent"] {
  ...
  render() {
    ...
    return wp.element.createElement("div", {
      ...
      ,
      label: sprintf(/* Translators: %s - the singular label for a ticket. */
      Object(external_wp_i18n_["__"])('%s price', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular)
    }), wp.element.createElement(react_number_format_es["a" /* NumericFormat */], extends_default()({
      allowNegative: false,
...
defineProperty_default()(template_Price, "propTypes", {
  ...
  tempPrice: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.string, external_tribe_modules_propTypes_default.a.number]),
...
const container_content_price_container_mapDispatchToProps = (dispatch, ownProps) => ({
  onTempPriceChange: e => {
    ...
    dispatch(ticket["a" /* actions */].setTicketTempPrice(clientId, e.value));
    dispatch(ticket["a" /* actions */].setTicketHasChanges(clientId, true));
  }
});
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/type/styles.pcss
var type_styles = __webpack_require__("H+Mp");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/type/template.js
/**
 * External dependencies
 */
...
const Type = ({
  ...
  return wp.element.createElement("div", {
    className: external_tribe_modules_classnames_default()('tribe-editor__ticket__type', 'tribe-editor__ticket__content-row', 'tribe-editor__ticket__content-row--type')
  }, wp.element.createElement(modules_elements["LabelWithTooltip"], {
    ...
    ,
    label: sprintf(/* Translators: %s - the singular label for a ticket. */
    Object(external_wp_i18n_["_x"])('%s type', 'Block Editor Ticket type label', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular),
    ...
    className: "tribe-editor__ticket__type__description"
  }, wp.element.createElement("div", {
    className: "tribe-editor__ticket__type__type-title"
  }, typeIcon, wp.element.createElement("span", null, typeName)), upsellMessage ? wp.element.createElement("div", {
    className: "tribe-editor__ticket__type__type-upsell-description"
  }, wp.element.createElement(icons["ECP"], null), wp.element.createElement("span", {
    dangerouslySetInnerHTML: htmlTypeUpsellDescription
  })) : null));
};
Type.propTypes = {
  typeName: external_tribe_modules_propTypes_default.a.string,
  typeDescription: external_tribe_modules_propTypes_default.a.string,
  upsellMessage: external_tribe_modules_propTypes_default.a.string,
  typeIcon: external_tribe_modules_propTypes_default.a.node
};
/* harmony default export */ var type_template = (Type);
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/type/container.js
/**
 * External dependencies
 */
...
const type_container_mapStateToProps = (state, ownProps) => {
  ...
  const typeName = Object(external_wp_i18n_["sprintf"])(/* Translators: %s - the singular label for a ticket. */
  Object(external_wp_i18n_["_x"])('Standard %s', 'Default ticket type label.', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular);
  ...
  const upsellMessage = !hasEventsPro && currentPostIsEvent ? Object(external_wp_i18n_["sprintf"])(/* Translators: %s - the singular label for a ticket. */
  Object(external_wp_i18n_["_x"])('For more %s types, <a href="https://evnt.is/tt-ecp" target="_blank" rel="noopener noreferrer">upgrade</a> to Events Calendar Pro', 'Default ticket type upsell description.', 'event-tickets'), constants["TICKET_LABELS"].ticket.singularLowercase) : null;
  const typeIcon = wp.element.createElement(icons["Ticket"], null);
  let mappedProps = {
    typeName,
    typeDescription,
    upsellMessage,
   ...
   */
  mappedProps = Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.Tickets.Type.mappedProps', mappedProps, {
    state,
    ownProps,
    ticketDetails
  });
...
/* harmony default export */ var type_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(type_container_mapStateToProps))(type_template));
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/style.pcss
var container_content_style = __webpack_require__("DoMS");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/template.js
/**
 * External dependencies
 */
...
const TicketContainerContent = ({
  clientId,
  hasTicketsPlus,
  hasIacVars
}) => {
  return wp.element.createElement(external_React_["Fragment"], null, getTicketContainerItems(clientId, hasTicketsPlus, hasIacVars).map(item => wp.element.createElement(external_React_["Fragment"], {
    key: item.key
  }, item.item)));
};
...
/* harmony default export */ var container_content_template = (TicketContainerContent);
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container-content/container.js
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/container/template.js
/**
 * External dependencies
 */
...
const ClockIcon = ({
  isDisabled
}) => isDisabled ? wp.element.createElement(icons["ClockInactive"], null) : wp.element.createElement(icons["ClockActive"], null);
ClockIcon.propTypes = {
  isDisabled: external_tribe_modules_propTypes_default.a.bool.isRequired
};
const TicketIcon = ({
  isDisabled
}) => isDisabled ? wp.element.createElement(icons["TicketInactive"], null) : wp.element.createElement(icons["TicketActive"], null);
TicketIcon.propTypes = {
  isDisabled: external_tribe_modules_propTypes_default.a.bool.isRequired
};
const TicketContainerIcon = ({
  isDisabled,
  isFuture,
  isPast
}) => isFuture || isPast ? wp.element.createElement(ClockIcon, {
  isDisabled: isDisabled
...
const TicketContainer = ({
  ...
  isSelected,
  isOnSale
}) => wp.element.createElement(modules_elements["ContainerPanel"], {
...
var move_delete_style = __webpack_require__("+jqo");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/dashboard/move-delete/template.js
/**
 * External Dependencies
 */
...
const RemoveTicketButton = ({
  ...
  onClick: onClick,
  disabled: isDisabled
}, sprintf(/* Translators: %s - the singular label for a ticket. */
Object(external_wp_i18n_["__"])('Remove %s', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular));
const MoveTicketButton = ({
  onClick,
  isDisabled
}) => wp.element.createElement(external_tribe_common_elements_["Button"], {
  type: "button",
...
Object(external_wp_i18n_["__"])('Move %s', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular));
const MoveDelete = ({
  ticketIsSelected,
  moveTicket,
  removeTicket,
  ...
  let actions = [{
    item: wp.element.createElement(RemoveTicketButton, {
      onClick: removeTicket,
      isDisabled: isDisabled
    }),
    key: 'remove'
  }, {
    item: wp.element.createElement(MoveTicketButton, {
      onClick: moveTicket,
      isDisabled: isDisabled
    }),
    key: 'move'
   ...
   */
  actions = Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.Ticket.actionItems', actions, clientId);
  return wp.element.createElement("div", {
    className: "tribe-editor__ticket__content-row--move-delete"
  }, actions.map(action => wp.element.createElement(external_React_default.a.Fragment, {
    key: action.key
  }, action.item)));
};
...
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/dashboard/move-delete/container.js
...
const move_delete_container_mapStateToProps = (state, ownProps) => ({
  isDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
  ticketIsSelected: ticket["f" /* selectors */].getTicketIsSelected(state, ownProps),
  ticketId: ticket["f" /* selectors */].getTicketId(state, ownProps)
});
const move_delete_container_mapDispatchToProps = (dispatch, ownProps) => ({
  removeTicket: () => {
    dispatch(ticket["a" /* actions */].deleteTicket(ownProps.clientId));
  },
  moveTicket: ticketId => dispatch(Object(move_actions["c" /* showModal */])(ticketId, ownProps.clientId))
});
const container_mergeProps = (stateProps, dispatchProps, ownProps) => container_objectSpread(container_objectSpread(container_objectSpread(container_objectSpread({}, stateProps), dispatchProps), ownProps), {}, {
...
// EXTERNAL MODULE: ./src/Tickets/Blocks/Ticket/app/editor/dashboard/style.pcss
var dashboard_style = __webpack_require__("DCmc");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/dashboard/template.js
/**
 * External dependencies
 */
...
const confirmLabel = hasBeenCreated => {
  ...
  // eslint-disable-next-line no-undef
  sprintf(/* Translators: %s - the singular label for a ticket. */
  Object(external_wp_i18n_["__"])('Update %s', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular) :
  // eslint-disable-next-line no-undef
  sprintf(/* Translators: %s - the singular label for a ticket. */
  Object(external_wp_i18n_["__"])('Create %s', 'event-tickets'), constants["TICKET_LABELS"].ticket.singular);
};
...
const TicketDashboard = ({
  ...
  onCancelClick,
  onConfirmClick
}) => wp.element.createElement(external_React_["Fragment"], null, hasBeenCreated && wp.element.createElement(move_delete_container, {
  clientId: clientId
}), wp.element.createElement(modules_elements["ActionDashboard"], {
...
/* harmony default export */ var dashboard_template = (TicketDashboard);
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/dashboard/container.js


const dashboard_container_excluded = ["state"];
function dashboard_container_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function dashboard_container_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? dashboard_container_ownKeys(Object(t), !0).forEach(function (r) { defineProperty_default()(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : dashboard_container_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
/**
 * External dependencies
 */
...
const getIsConfirmDisabled = (state, ownProps) => {
  const shouldConfirmBeDisabled = ticket["f" /* selectors */].isTicketDisabled(state, ownProps) || ticket["f" /* selectors */].getTicketHasDurationError(state, ownProps) || !ticket["f" /* selectors */].getTicketHasChanges(state, ownProps) || !ticket["f" /* selectors */].isTicketValid(state, ownProps);
   ...
   * @param {Object}  ownProps   The own props of the component.
   */
  return Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.confirmButton.isDisabled', shouldConfirmBeDisabled, state, ownProps);
};
const container_onCancelClick = (state, dispatch, ownProps) => () => {
  if (ticket["f" /* selectors */].getTicketHasBeenCreated(state, ownProps)) {
    dispatch(ticket["a" /* actions */].setTicketTempDetails(ownProps.clientId, {
      title: ticket["f" /* selectors */].getTicketTitle(state, ownProps),
      description: ticket["f" /* selectors */].getTicketDescription(state, ownProps),
      price: ticket["f" /* selectors */].getTicketPrice(state, ownProps),
      sku: ticket["f" /* selectors */].getTicketSku(state, ownProps),
      iac: ticket["f" /* selectors */].getTicketIACSetting(state, ownProps),
      startDate: ticket["f" /* selectors */].getTicketStartDate(state, ownProps),
      startDateInput: ticket["f" /* selectors */].getTicketStartDateInput(state, ownProps),
      startDateMoment: ticket["f" /* selectors */].getTicketStartDateMoment(state, ownProps),
      endDate: ticket["f" /* selectors */].getTicketEndDate(state, ownProps),
      endDateInput: ticket["f" /* selectors */].getTicketEndDateInput(state, ownProps),
      endDateMoment: ticket["f" /* selectors */].getTicketEndDateMoment(state, ownProps),
      startTime: ticket["f" /* selectors */].getTicketStartTime(state, ownProps),
      endTime: ticket["f" /* selectors */].getTicketEndTime(state, ownProps),
    ...
    dispatch(ticket["a" /* actions */].removeTicketBlock(ownProps.clientId));
    Object(external_wp_data_["dispatch"])('core/block-editor').removeBlocks(ownProps.clientId);
  }
  Object(external_wp_data_["dispatch"])('core/block-editor').clearSelectedBlock();
};
const container_onConfirmClick = (state, dispatch, ownProps) => () => ticket["f" /* selectors */].getTicketHasBeenCreated(state, ownProps) ? dispatch(ticket["a" /* actions */].updateTicket(ownProps.clientId)) : dispatch(ticket["a" /* actions */].createNewTicket(ownProps.clientId));
const dashboard_container_mapStateToProps = (state, ownProps) => ({
  hasBeenCreated: ticket["f" /* selectors */].getTicketHasBeenCreated(state, ownProps),
  isCancelDisabled: ticket["f" /* selectors */].isTicketDisabled(state, ownProps),
...
const dashboard_container_mergeProps = (stateProps, dispatchProps, ownProps) => {
  ...
  return dashboard_container_objectSpread(dashboard_container_objectSpread(dashboard_container_objectSpread({}, ownProps), restStateProps), {}, {
    onCancelClick: container_onCancelClick(state, dispatch, ownProps),
    onConfirmClick: container_onConfirmClick(state, dispatch, ownProps)
  });
};
/* harmony default export */ var dashboard_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])(), Object(external_tribe_modules_reactRedux_["connect"])(dashboard_container_mapStateToProps, null, dashboard_container_mergeProps))(dashboard_template));
// EXTERNAL MODULE: ./src/modules/elements/move-modal/index.js + 2 modules
var move_modal = __webpack_require__("mzTd");

// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/template.js
...
class template_Ticket extends external_React_["PureComponent"] {
  ...
  render() {
     ...
     */
    const filteredIsSelected = Object(external_wp_hooks_["applyFilters"])('tec.tickets.blocks.Ticket.isSelected', isSelected, this.props);
    return showTicket ? wp.element.createElement(external_React_["Fragment"], null, wp.element.createElement("article", {
      className: external_tribe_modules_classnames_default()('tribe-editor__ticket', {
        ...
        'tribe-editor__ticket--is-asc': Object(external_wp_hooks_["applyFilters"])('tribe.editor.ticket.isAsc', false, clientId)
      })
      ...
      clientId: clientId,
      isSelected: filteredIsSelected
    }), isLoading && wp.element.createElement(external_wp_components_["Spinner"], null)), isModalShowing && wp.element.createElement(move_modal["a" /* default */], null)) : null;
  }
}
...
/* harmony default export */ var editor_template = (template_Ticket);
...
function editor_container_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function editor_container_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? editor_container_ownKeys(Object(t), !0).forEach(function (r) { defineProperty_default()(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : editor_container_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
/**
 * External dependencies
 */
...
const editor_container_mapDispatchToProps = (dispatch, ownProps) => {
  const {
    clientId
  } = ownProps;
  return {
    onBlockUpdate: isSelected => dispatch(ticket["a" /* actions */].setTicketIsSelected(clientId, isSelected)),
    setInitialState: props => {
      dispatch(ticket["a" /* actions */].registerTicketBlock(clientId));
      dispatch(ticket["a" /* actions */].setTicketInitialState(props));
    }
  };
};
const editor_container_mergeProps = (stateProps, dispatchProps, ownProps) => editor_container_objectSpread(editor_container_objectSpread(editor_container_objectSpread(editor_container_objectSpread({}, stateProps), dispatchProps), ownProps), {}, {
  isModalShowing: stateProps.isModalShowing && stateProps.modalTicketId === stateProps.ticketId
});
/* harmony default export */ var editor_container = (Object(external_tribe_modules_redux_["compose"])(Object(external_tribe_common_hoc_["withStore"])({
  isolated: true
}), Object(external_tribe_modules_reactRedux_["connect"])(editor_container_mapStateToProps, editor_container_mapDispatchToProps, editor_container_mergeProps), Object(with_save_data["a" /* default */])())(editor_template));
// CONCATENATED MODULE: ./src/Tickets/Blocks/Ticket/app/editor/index.js
/**
 * External dependencies
 */
...
const block = {
  ...
  save() {
    ...
    return wp.element.createElement("div", blockProps, wp.element.createElement(InnerBlocks.Content, null));
  }
};
Object(external_wp_blocks_["registerBlockType"])(`tribe/tickets-item`, block);
...
/* harmony import */ var react_textarea_autosize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("z430");
...
const TicketContainerHeaderDescription = ({
  ...
  tempDescription,
  description
}) => isSelected ? wp.element.createElement(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
...
module.exports = lodash.isString;
 ...
 */
/* harmony default export */ __webpack_exports__["a"] = ((selectedAttributes = null) => WrappedComponent => {
...
AttendeeRegistrationIcons.propTypes = {
  ...
  clientId: external_tribe_modules_propTypes_default.a.string,
  fromDate: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.instanceOf(Date), external_tribe_modules_propTypes_default.a.string]).isRequired,
  hasAttendeeInfoFields: external_tribe_modules_propTypes_default.a.bool,
  ...
  toDate: external_tribe_modules_propTypes_default.a.oneOfType([external_tribe_modules_propTypes_default.a.instanceOf(Date), external_tribe_modules_propTypes_default.a.string]).isRequired
};
...
const mapStateToProps = (state, ownProps) => {
  ...
  const selectedBlock = container_select('core/block-editor').getSelectedBlock();
  return {
    attendeeInfoFieldsLabel,
    hasAttendeeInfoFields,
